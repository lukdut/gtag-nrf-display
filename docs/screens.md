...
В версии 0.6.0 откройте **Настройки → Устройства и службы → GTag Display →
Настроить** у нужной записи интеграции. Доступны три макета:
...
Сущности самой интеграции не предлагаются в качестве источников данных:
отслеживание статуса собственной передачи вызвало бы непрерывные обновления.
