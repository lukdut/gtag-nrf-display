...
Нижние три ряда оставлены свободными под индикатор батареи; для этого
ссылка поднята на 2 пикселя относительно первоначального макета.
...
Заставка включена по умолчанию в профили BLE и Zigbee релиза 0.9.0, включая
