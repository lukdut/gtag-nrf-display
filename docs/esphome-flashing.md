...
Мастер доступен в версии интеграции после **0.9.0**. При использовании
опубликованной 0.9.0 сохраните подходящий полный пример из
[инструкции по конфигурации](device-configuration.md) и внесите свои настройки.
Сами пакеты прошивки в YAML закреплены на теге **v0.9.0**.
